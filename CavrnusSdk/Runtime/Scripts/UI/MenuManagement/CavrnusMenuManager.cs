...
{
    public class CavrnusMenuManager : MonoBehaviour
    {
        public static CavrnusMenuManager Instance;

        [SerializeField] private CavrnusMenusScriptableObject cavrnusMenus;
        ...
        private MenuInformation LazyMenuInfoLookup(string menu)
        {
            ...
            if (!knownMenus.ContainsKey(menu)) {
                var mi =  new MenuInformation {
                    MenuPrefab = cavrnusMenus.GetMenu(menu),
