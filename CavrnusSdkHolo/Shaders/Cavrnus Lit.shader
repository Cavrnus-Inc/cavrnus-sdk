	...
	SubShader
{
		...
		Pass
		{
			...
			#pragma multi_compile_local _ _INVERTSMOOTHNESS //Only exists in Metallic Mode, so should be compiled out from Specular Workflow.
			...
			#pragma multi_compile_local _ _SPECULAR_SETUP
			...
			//TODO: later. Part of the urp 12 upgrade.
